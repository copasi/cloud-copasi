...
<!-- generated with COPASI 4.6.34 (development) (http://www.copasi.org) at 2011-02-28 15:23:40 UTC -->
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Model_1">
    <dcterms:created>
      <rdf:Description>
        <dcterms:W3CDTF>2011-01-18T16:45:42Z</dcterms:W3CDTF>
      </rdf:Description>
    </dcterms:created>
  </rdf:Description>
</rdf:RDF>
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_0">
    <dcterms:created>
      <rdf:Description>
        <dcterms:W3CDTF>2011-01-20T15:13:44Z</dcterms:W3CDTF>
      </rdf:Description>
    </dcterms:created>
  </rdf:Description>
</rdf:RDF>
        ...
        <ListOfConstants>
          <Constant key="Parameter_89" name="Kms" value="0.0954423"/>
          <Constant key="Parameter_90" name="Kmp" value="0.104808"/>
          <Constant key="Parameter_91" name="Vf" value="0.109751"/>
          <Constant key="Parameter_92" name="Vr" value="0.09"/>
        </ListOfConstants>
    ...
    <InitialState type="initialState">
      0 6.022141790000001e+20 6.022141790000001e+20 1 
    </InitialState>
  </Model>
  <ListOfTasks>
    ...
    <Task key="Task_16" name="Optimization" type="optimization" scheduled="true" updateModel="false">
      <Report reference="Report_10" target="" append="1"/>
      <Problem>
        <Parameter name="Subtask" type="cn" value="CN=Root,Vector=TaskList[Steady-State]"/>
        <ParameterText name="ObjectiveExpression" type="expression">
          &lt;CN=Root,Model=New Model,Vector=Reactions[reaction_1],ParameterGroup=Parameters,Parameter=Vr,Reference=Value&gt;
        </ParameterText>
        ...
        <ParameterGroup name="OptimizationItemList">
          <ParameterGroup name="OptimizationItem">
            ...
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=New Model,Vector=Reactions[reaction_1],ParameterGroup=Parameters,Parameter=Kmp,Reference=Value"/>
            <Parameter name="StartValue" type="float" value="0.1"/>
            <Parameter name="UpperBound" type="cn" value="0.11"/>
          </ParameterGroup>
          <ParameterGroup name="OptimizationItem">
            <Parameter name="LowerBound" type="cn" value="0.09"/>
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=New Model,Vector=Reactions[reaction_1],ParameterGroup=Parameters,Parameter=Kms,Reference=Value"/>
            <Parameter name="StartValue" type="float" value="0.1"/>
            <Parameter name="UpperBound" type="cn" value="0.11"/>
          </ParameterGroup>
          <ParameterGroup name="OptimizationItem">
            <Parameter name="LowerBound" type="cn" value="0.09"/>
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=New Model,Vector=Reactions[reaction_1],ParameterGroup=Parameters,Parameter=Vf,Reference=Value"/>
            <Parameter name="StartValue" type="float" value="0.1"/>
            <Parameter name="UpperBound" type="cn" value="0.11"/>
          </ParameterGroup>
          <ParameterGroup name="OptimizationItem">
            <Parameter name="LowerBound" type="cn" value="0.09"/>
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=New Model,Vector=Reactions[reaction_1],ParameterGroup=Parameters,Parameter=Vr,Reference=Value"/>
            <Parameter name="StartValue" type="float" value="0.1"/>
            <Parameter name="UpperBound" type="cn" value="0.11"/>
          </ParameterGroup>
        </ParameterGroup>
  ...
  <ListOfReports>
    ...
    <Report key="Report_17" name="report_2" taskType="timeCourse" separator="&#x09;" precision="6">
      <Comment>
    ...
    <Report key="Report_18" name="report_3" taskType="scan" separator="&#x09;" precision="6">
      <Comment>
        
      </Comment>
      <Table printTitle="1">
        <Object cn="CN=Root,Model=New Model,Vector=Reactions[reaction_1],ParameterGroup=Parameters,Parameter=Vr,Reference=Value"/>
        <Object cn="CN=Root,Model=New Model,Vector=Reactions[reaction_1],ParameterGroup=Parameters,Parameter=Vf,Reference=Value"/>
      </Table>
    </Report>
    <Report key="Report_19" name="report_4" taskType="optimization" separator="&#x09;" precision="6">
      <Comment>
    ...
    <Report key="Report_20" name="report_5" taskType="timeCourse" separator="&#x09;" precision="6">
      <Comment>
