# Generated by Django 3.1.5 on 2022-03-22 01:31
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'unique_together': {('user', 'access_key_id'), ('user', 'name')},
            },
        ),
        migrations.CreateModel(
            name='CondorPool',
            fields=[
                ...
                ('platform', models.CharField(choices=[('DEB6', 'Debian 6'), ('DEB7', 'Debian 7'), ('RH5', 'Red Hat 5'), ('RH6', 'Red Hat 6'), ('RH7', 'Red Hat 7'), ('CentOS7', 'CentOS 7'), ('UBUNTU12', 'Ubuntu 12'), ('MACOS', 'MAC OS')], default='DEB6', max_length=8, verbose_name='The platform of the remote condor submitter we are connecting to')),
