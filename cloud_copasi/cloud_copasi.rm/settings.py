...
CLOUD_COPASI_DIR = '/home/cloudcopasi/cloud-copasi/cloud_copasi/'
HTML_5UP = os.path.join(CLOUD_COPASI_DIR, 'html5up')

TEMPLATES_DIR = os.path.join(CLOUD_COPASI_DIR, 'web_interface/templates/')
PLUGINS_DIR = os.path.join(CLOUD_COPASI_DIR, 'web_interface/task_plugins/plugins')
HTML5UP_STATIC = os.path.join(CLOUD_COPASI_DIR, 'html5up/static')
...
DATABASES = {
    'default': {
        ...
        'NAME': 'cloud_copasi_db_new',                      # Or path to database file if using sqlite3.
        'USER': 'cloud_copasi_user_new',                      # Not used with sqlite3.
...
SECRET_KEY = 'bk7s$3th!ox=h@1w_$d5$x!^*@m@8@4r*w)q@0-(a^8ydxio+m'
...
HOST='cloud-copasi-new.cam.uchc.edu'
...
#HOME_DIR='/home/cloudcopasi/cloud-copasi/'
...
STORAGE_DIR = '/home/cloudcopasi/cloud-copasi/user-files/'
KEYPAIR_FILEPATH = '/home/cloudcopasi/cloud-copasi/instance_keypairs/'
...
STATIC_ROOT = os.path.join(TEMPLATES_DIR, 'static-all')
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file' : {
            ...
            'filename': os.path.join(LOG_DIR, 'cloud-copasi-NEW.log'),
