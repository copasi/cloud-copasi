...
<!-- generated with COPASI 4.6.34 (development) (http://www.copasi.org) at 2011-02-10 14:06:18 UTC -->
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Model_1">
    <dcterms:created>
      <rdf:Description>
        <dcterms:W3CDTF>2011-02-03T13:25:22Z</dcterms:W3CDTF>
      </rdf:Description>
    </dcterms:created>
  </rdf:Description>
</rdf:RDF>
...
<p>You should experiment solving the problem with several optimisation methods, such as Nelder-Mead, Levenberg-Marquardt, Genetic algorithm, or Particle swarm (others are good too).</p>
      ...
      <Problem>
        ...
        <ParameterGroup name="OptimizationItemList">
          <ParameterGroup name="FitItem">
            ...
            <Parameter name="StartValue" type="float" value="125.659"/>
          ...
          <ParameterGroup name="FitItem">
            ...
            <Parameter name="StartValue" type="float" value="14.0251"/>
            <Parameter name="UpperBound" type="cn" value="1000"/>
          </ParameterGroup>
          <ParameterGroup name="FitItem">
            <ParameterGroup name="Affected Experiments">
            ...
            <Parameter name="StartValue" type="float" value="46.0991"/>
            <Parameter name="UpperBound" type="cn" value="1000"/>
          </ParameterGroup>
        </ParameterGroup>
        <ParameterGroup name="OptimizationConstraintList">
        ...
        <ParameterGroup name="Experiment Set">
          <ParameterGroup name="Experiment">
            ...
            <Parameter name="File Name" type="file" value="KinMMFitData.txt"/>
            ...
            <ParameterGroup name="Object Map">
              ...
              <ParameterGroup name="1">
                <Parameter name="Object CN" type="cn" value="CN=Root,Model=Kinetics of a  Michaelian enzyme measured spectrophotometrically,Vector=Compartments[compartment],Vector=Metabolites[S],Reference=Concentration"/>
  ...
  <ListOfReports>
    ...
    <Report key="Report_17" name="report_2" taskType="parameterFitting" separator="&#x09;" precision="6">
      <Comment>
        <body xmlns="http://www.w3.org/1999/xhtml">
    ...
    <PlotSpecification name="Concentrations, Volumes, and Global Quantity Values" type="Plot2D" active="1">
      ...
      <ListOfPlotItems>
        <PlotItem name="[S]" type="Curve2D">
          ...
          <Parameter name="Recording Activity" type="string" value="during"/>
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Kinetics of a  Michaelian enzyme measured spectrophotometrically,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Kinetics of a  Michaelian enzyme measured spectrophotometrically,Vector=Compartments[compartment],Vector=Metabolites[S],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[E]" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Kinetics of a  Michaelian enzyme measured spectrophotometrically,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Kinetics of a  Michaelian enzyme measured spectrophotometrically,Vector=Compartments[compartment],Vector=Metabolites[E],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[ES]" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
          <Parameter name="Recording Activity" type="string" value="during"/>
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Kinetics of a  Michaelian enzyme measured spectrophotometrically,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Kinetics of a  Michaelian enzyme measured spectrophotometrically,Vector=Compartments[compartment],Vector=Metabolites[ES],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[P]" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Kinetics of a  Michaelian enzyme measured spectrophotometrically,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Kinetics of a  Michaelian enzyme measured spectrophotometrically,Vector=Compartments[compartment],Vector=Metabolites[P],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="Values[Abs]" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
          <Parameter name="Recording Activity" type="string" value="during"/>
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Kinetics of a  Michaelian enzyme measured spectrophotometrically,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Kinetics of a  Michaelian enzyme measured spectrophotometrically,Vector=Values[Abs],Reference=Value"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="Values[Keq(1)]" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
          <Parameter name="Recording Activity" type="string" value="during"/>
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Kinetics of a  Michaelian enzyme measured spectrophotometrically,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Kinetics of a  Michaelian enzyme measured spectrophotometrically,Vector=Values[Keq(1)],Reference=Value"/>
          </ListOfChannels>
        </PlotItem>
      </ListOfPlotItems>
    </PlotSpecification>
