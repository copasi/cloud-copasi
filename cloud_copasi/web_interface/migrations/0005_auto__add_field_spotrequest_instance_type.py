...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SpotRequest.instance_type'
        db.add_column(u'web_interface_spotrequest', 'instance_type',
                      self.gf('django.db.models.fields.CharField')(default='unknown', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SpotRequest.instance_type'
        db.delete_column(u'web_interface_spotrequest', 'instance_type')
    ...
    models = {
        ...
        'web_interface.ec2pool': {
            ...
            'secret_key': ('django.db.models.fields.CharField', [], {'default': "'ZuQea8bvIPblERfb4blRAjLJgEnZ2u'", 'max_length': '30'}),
