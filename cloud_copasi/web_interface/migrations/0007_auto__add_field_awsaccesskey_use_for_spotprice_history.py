...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AWSAccessKey.use_for_spotprice_history'
        db.add_column(u'web_interface_awsaccesskey', 'use_for_spotprice_history',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AWSAccessKey.use_for_spotprice_history'
        db.delete_column(u'web_interface_awsaccesskey', 'use_for_spotprice_history')
    ...
    models = {
        ...
        'web_interface.ec2pool': {
            ...
            'secret_key': ('django.db.models.fields.CharField', [], {'default': "'FmEDhPbVPNS16uS1c6PMeBffhsIBpx'", 'max_length': '30'}),
