...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EC2Pool.spot_price_bid'
        db.add_column(u'web_interface_ec2pool', 'spot_price_bid',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'EC2Pool.spot_price_bid'
        db.delete_column(u'web_interface_ec2pool', 'spot_price_bid')
    ...
    models = {
        ...
        'web_interface.ec2pool': {
            ...
            'secret_key': ('django.db.models.fields.CharField', [], {'default': "'cqlVXIwGea3AARofr64kY81TVCBhSB'", 'max_length': '30'}),
