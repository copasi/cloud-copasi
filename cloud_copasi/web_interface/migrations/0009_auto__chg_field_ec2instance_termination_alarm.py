...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EC2Instance.termination_alarm'
        db.alter_column(u'web_interface_ec2instance', 'termination_alarm', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'EC2Instance.termination_alarm'
        db.alter_column(u'web_interface_ec2instance', 'termination_alarm', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))
    ...
    models = {
        ...
        'web_interface.ec2pool': {
            ...
            'secret_key': ('django.db.models.fields.CharField', [], {'default': "'3mPVfyN4oehk1Car3K6quVzVVKIDDi'", 'max_length': '30'}),
