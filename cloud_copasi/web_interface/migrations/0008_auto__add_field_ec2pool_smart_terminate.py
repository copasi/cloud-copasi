...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EC2Pool.smart_terminate'
        db.add_column(u'web_interface_ec2pool', 'smart_terminate',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EC2Pool.smart_terminate'
        db.delete_column(u'web_interface_ec2pool', 'smart_terminate')
    ...
    models = {
        ...
        'web_interface.ec2pool': {
            ...
            'secret_key': ('django.db.models.fields.CharField', [], {'default': "'8kq3u78XNQfs2Hpv7GUqKAbQ3NQg4S'", 'max_length': '30'}),
