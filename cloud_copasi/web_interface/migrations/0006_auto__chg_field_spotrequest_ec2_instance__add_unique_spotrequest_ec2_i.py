...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SpotRequest.ec2_instance'
        db.alter_column(u'web_interface_spotrequest', 'ec2_instance_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['web_interface.EC2Instance'], unique=True, null=True))
        # Adding unique constraint on 'SpotRequest', fields ['ec2_instance']
        db.create_unique(u'web_interface_spotrequest', ['ec2_instance_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'SpotRequest', fields ['ec2_instance']
        db.delete_unique(u'web_interface_spotrequest', ['ec2_instance_id'])


        # Changing field 'SpotRequest.ec2_instance'
        db.alter_column(u'web_interface_spotrequest', 'ec2_instance_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web_interface.EC2Instance'], null=True))
    ...
    models = {
        ...
        'web_interface.ec2pool': {
            ...
            'secret_key': ('django.db.models.fields.CharField', [], {'default': "'sho8ulQ3d0555hFAfWZimlMV3w6W6P'", 'max_length': '30'}),
