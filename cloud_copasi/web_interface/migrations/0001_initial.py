    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('platform', models.CharField(choices=[(b'DEB6', b'Debian 6'), (b'RH5', b'Red Hat 5'), (b'RH6', b'Red Hat 6')], default=b'DEB6', max_length=4, verbose_name=b'The platform of the remote condor submitter we are connecting to')),
                ...
                ('pool_type', models.CharField(choices=[(b'condor', b'Condor'), (b'pbs', b'PBS'), (b'lsf', b'LSF'), (b'sge', b'Sun Grid Engine')], default=b'condor', max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='EC2Instance',
