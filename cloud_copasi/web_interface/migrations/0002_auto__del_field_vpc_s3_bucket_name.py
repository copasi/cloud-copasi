...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'VPC.s3_bucket_name'
        db.delete_column(u'web_interface_vpc', 's3_bucket_name')


    def backwards(self, orm):
        # Adding field 'VPC.s3_bucket_name'
        db.add_column(u'web_interface_vpc', 's3_bucket_name',
    ...
    models = {
        ...
        'web_interface.ec2pool': {
            ...
            'secret_key': ('django.db.models.fields.CharField', [], {'default': "'vUnLCEjeGJvBST3rYifCpKrXydhC5u'", 'max_length': '30'}),
